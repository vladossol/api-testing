...
Bug Report
Documented bugs report is stored in a dedicated folder 'deliverables' within the project.

Test Reports
Playwright test output (HTML report) is stored in a dedicated folder 'deliverables' within the project.
